...
interface OpenAITriggerDialogProps {
    open: boolean;
...
export const OpenAITriggerDialog = ({ open, onOpenChange, onSubmit, defaultValues = {} }: OpenAITriggerDialogProps) => {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>OpenAI Node Configuration</DialogTitle>
                    <DialogDescription>
                        Configure the OpenAI node settings here. Add API Key and prompts as needed
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form
