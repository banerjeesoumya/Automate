        ...
        <div className="container mx-auto px-4 py-24 sm:py-32 relative z-10 flex-1 flex flex-col">
          <div className="mx-auto max-w-5xl text-center flex-1 flex flex-col justify-center">
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 id="main-title" className="text-4xl font-bold tracking-tight text-foreground sm:text-6xl lg:text-7xl max-w-5xl mx-auto">
                Production-ready workflows <br />
            ...
            >
              Visually orchestrate AI-powered workflows that connect your HR tools and internal systems in minutes.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Trusted by teams automating critical workflows</p>
