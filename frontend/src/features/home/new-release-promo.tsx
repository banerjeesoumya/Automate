        ...
        <div className="relative mx-auto h-[400px] max-w-4xl overflow-hidden rounded-[38px] border border-black/5 dark:border-white/20 bg-primary p-2 shadow-sm">
          ...
          <div className="relative z-10">
            <div className="mt-8 text-center">
              <h2 className="text-4xl font-bold text-primary-foreground mb-6">Ship workflows, not glue code.</h2>
              <p className="text-primary-foreground/60 mb-8">Designed for product teams that want automation without a new backend.</p>
              <svg
                width="100"
                height="50"
                viewBox="0 0 100 50"
